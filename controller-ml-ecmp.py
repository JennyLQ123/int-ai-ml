...
ECMP={'02': ['012', '0142'], '01': ['01', '031'], '07': ['0147', '0357'], '08': ['08', '038'], '61': ['631', '6301'], '62': ['6312', '6542'], '67': ['67', '657'], '68': ['68', '638']}
STATIC={'02': ['012', '012'], '01': ['01', '01'], '07': ['0357', '0357'], '08': ['08', '08'], '61': ['631', '631'], '62': ['6542', '6542'], '67': ['67', '67'], '68': ['68', '68']}
...
def controllerMain(data_info,flag):
    ...
    for ep in range(EP_START+1,EP_MAX):
        ...
        for t in range(EP_LEN):    # in one episode
            ...
            w = {sp+"1":STATIC[sp][0],sp+"2":STATIC[sp][1]}
        ...
        with open("raw_data/static%d"%(ep,),"w") as f:
            for s in ep_s:
                for _ in s[-19:]:
                    f.write(str(_)+" ")
                f.write("\n")
